...
bases <- trbl_interval(
  ~chrom, ~start, ~end, 
  "chr1", 0,      1,  # first base of the chrom
  "chr1", 1,      2,  # second base of the chrom
  "chr1", 99,     100 # last base of chrom
)
...
Examples of interval statistics are available in `vignette('interval-statistics')`.

## Benchmarks

Current benchmarks are available in `vignette('benchmarks')`.
