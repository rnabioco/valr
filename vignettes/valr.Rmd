...
`valr` can also operate on BED-like data.frames already constructed in R, provided that columns `chrom`, `start` and `end` are present. Additionally tbls can also be hand-contructed using `trbl_intervals()`.
