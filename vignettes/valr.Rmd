...
We can then use the following function to generate a 20x20 table of jaccard similarities.
...
The data can also be visualized as a heat map. This requires the `gplots` package, which can be installed by running `install.packages('gplots')`.
