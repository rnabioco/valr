...
The `group_by` function in dplyr is a powerful way to performs fuctions on subsets of a data_frame. Several functions in `valr` leverage grouping to enable a variety of analysis modes. These are discussed in the [grouping vignette][].
