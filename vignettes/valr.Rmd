...
We first need to read the data into RStudio as a list. 
...
The following code will create a plot for the principal component analysis. This requires that you have installed `ggplot2` and `RColorBrewer` by running `install.packages('ggplot2')` and `install.packages('RColorBrewer')`.
