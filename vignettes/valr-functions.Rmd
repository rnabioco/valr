...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 2
    vignette: >
      %\VignetteIndexEntry{valr-functions}
...
```{r read_genome}
genome_human <- read_genome(valr_example('hg19.chrom.sizes.gz'))
```
...
bed_glyph(bed_shuffle(x, genome, seed = seed))
```
