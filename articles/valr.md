...
[`db_ucsc()`](https://rnabioco.github.io/valr/reference/db.md) (to
access the UCSC Browser) and
[`db_ensembl()`](https://rnabioco.github.io/valr/reference/db.md) (to
...
Both single set
(e.g. [`bed_merge()`](https://rnabioco.github.io/valr/reference/bed_merge.md))
...
[`bed_map()`](https://rnabioco.github.io/valr/reference/bed_map.md) to
calculate a sum by mapping `y` signals onto the intervals in `x`. These
data are regrouped by `.win_id` and a summary with `mean` and `sd`
