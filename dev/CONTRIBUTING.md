...
This outlines how to propose a change to valr. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("rnabioco/valr", fork = TRUE)`.
...
of Conduct](https://rnabioco.github.io/valr/dev/CODE_OF_CONDUCT.md). By
